...
/*
 func timePickerTapped(textFieldObj: UITextField!) {
 ...
 datePicker.show("Select Drop Off Time",
 ...
 //                    dateformatter.dateFormat = "MMMM dd yyyy"//"MM/dd/yyyy"
 timeformatter.dateFormat = "hh:mm a"//"MM/dd/yyyy"
 self.dropTimeTextField.text = "\(timeformatter.string(from: dt))"
 }
 }
 }
 
 func datePickerTapped(textFieldObj: UITextField!) {
 let currentDate = Date()
 var dateComponents = DateComponents()
 dateComponents.year = 100
 let yearsLater = Calendar.current.date(byAdding: dateComponents, to: currentDate)
 ...
 dateformatter.dateFormat = "MMMM dd yyyy"//"MM/dd/yyyy"
 //                    timeformatter.dateFormat = "hh:mm a"//"MM/dd/yyyy"
 self.dateToStartTextField.text = "\(dateformatter.string(from: dt))"
 }
 }
 }
 */
...
//        self.datePicker.minuteInterval = 30
    ...
    open func showWithTimeInterval(_ title: String,
                   doneButtonTitle: String = "Done",
                   cancelButtonTitle: String = "Cancel",
                   defaultDate: Date = Date(),
                   minimumDate: Date? = nil, maximumDate: Date? = nil,
        ...
        self.datePicker.countDownDuration = 1
